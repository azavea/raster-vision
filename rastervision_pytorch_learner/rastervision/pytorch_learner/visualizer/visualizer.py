from typing import (TYPE_CHECKING, Sequence, Optional, List, Dict, Union, Tuple, Any)
...
from rastervision.pytorch_learner.learner_config import (
    RGBTuple, ChannelInds, ensure_class_colors, validate_channel_display_groups,
...
class Visualizer():
    ...
    def get_channel_display_groups(self, nb_img_channels: int) -> Union[
    ...
    def get_batch(self, dataset: 'Dataset', batch_sz: int=4, **kwargs) -> Tuple[
            Tensor, Any]:
