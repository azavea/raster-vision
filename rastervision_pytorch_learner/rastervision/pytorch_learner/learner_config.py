...
def get_default_channel_display_groups(nb_img_channels: int) -> Dict[str, ChannelInds]:
...
def validate_channel_display_groups(groups: Optional[
...
class PlotOptions(Config):
    ...
    channel_display_groups: Optional[Union[
        Dict[str, ChannelInds], Sequence[ChannelInds]]] = Field(
            None,
            description=
