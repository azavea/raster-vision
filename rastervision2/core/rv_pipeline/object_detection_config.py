...
class ObjectDetectionChipOptions(Config):
    neg_ratio: float = Field(1.0, description=(
    ...
    ioa_thresh: float = Field(0.8, description=(
...
class ObjectDetectionPredictOptions(Config):
    merge_thresh: float = Field(0.5, description=(
        ...
        'duplicates.'))
    score_thresh: float = Field(0.5, description=(
