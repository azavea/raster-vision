...
class ChipClassificationLabelSourceConfig(LabelSourceConfig):
    ...
    background_class_id: Optional[int] = Field(None, description=(
    ...
    infer_cells: bool = Field(
        False, description='If True, infers a grid of cells based on the cell_sz.')
    cell_sz: Optional[int] = Field(None, description='Size of a cell to use in pixels.')
