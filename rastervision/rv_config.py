...
class RVConfig:
    ...
    def set_tmp_dir(tmp_dir=None):
        ...
        value of RVConfig.tmp_dir is considered, then the DEFAULT_DIR is
        considered (/opt/data/tmp), and then a directory from
        ...
        if it:
            ...
            explicit_tmp_dir = RVConfig.DEFAULT_DIR
        ...
        # with, fall back to temp directory generated by tempfile.
        except Exception as e:
            RVConfig.tmp_dir = tempfile.TemporaryDirectory().name
            log.warning(
                'Root temporary directory cannot be used: {}. Using root: {}'.
                format(explicit_tmp_dir, RVConfig.tmp_dir))
        finally:
