...
from rastervision.backend.api import FASTAI_CHIP_CLASSIFICATION
...
class FastaiChipClassificationConfig(SimpleBackendConfig):
    train_opts_class = TrainOptions
    backend_type = FASTAI_CHIP_CLASSIFICATION
    backend_class = FastaiChipClassification


class FastaiChipClassificationConfigBuilder(SimpleBackendConfigBuilder):
    config_class = FastaiChipClassificationConfig
