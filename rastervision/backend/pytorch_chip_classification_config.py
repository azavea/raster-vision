    ...
    def with_train_options(self,
        ...
        Args:
            ...
            run_tensorboard: (bool) if True, run a Tensorboard server at
                ...
                option
            augmentors: (list of str) any of ['Blur', 'Rotate', 'HorizontalFlip',
                'GaussianBlur', or 'GaussNoise']. Augments the training data with
                a probability of 0.5. Uses the Albumentations libarary, see also
