...
from rastervision.v2.core import (Config, ConfigBuilder, BundledConfigMixin)
from rastervision.v2.task import TaskConfig
from rastervision.v2.data import (Scene, RasterSourceConfig, LabelSourceConfig,
                               LabelStoreConfig, GeoJSONVectorSource)
from rastervision.v2.protos.scene_pb2 \
