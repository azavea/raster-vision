...
from rastervision.v2.data.vector_source.geojson_vector_source import GeoJSONVectorSource
from rastervision.v2.data.vector_source.class_inference import ClassInferenceOptions
