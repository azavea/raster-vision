...
from rastervision.v2.data.raster_source.rasterio_source import RasterioSource
from rastervision.v2.data.raster_source.raster_source_config \
    import (RasterSourceConfig, RasterSourceConfigBuilder)
from rastervision.v2.protos.raster_source_pb2 \
