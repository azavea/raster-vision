...
class BundleCommand(Command):
    ...
    def __init__(self, bundle_config, task_config, scene_config, analyzer_configs):
    ...
    def run(self, tmp_dir):
        ...
        with zipfile.ZipFile(package_path, 'w') as package_zip:
            ...
            package_zip.write(bundle_config_path, arcname=os.path.basename(bundle_config_path))
